...
public class FruitShopDTO {
	...
	public String toString() {
		return "FruitShopDTO [itemId=" + itemId + ", itemName=" + itemName + ", itemBrand=" + itemBrand + ", price="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FruitShopDTO other = (FruitShopDTO) obj;
		if (itemBrand == null) {
	...
	public FruitShopDTO(int itemId, String itemName, String itemBrand, int price, int quantity, String itemImage) {
		super();
		this.itemId = itemId;
		this.itemName = itemName;
		this.itemBrand = itemBrand;
