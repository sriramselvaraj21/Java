...
public class GroceryShopDTO {
	...
	public String toString() {
		return "GroceryShopDTO [itemId=" + itemId + ", itemName=" + itemName + ", itemBrand=" + itemBrand + ", price="
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GroceryShopDTO other = (GroceryShopDTO) obj;
		if (itemBrand == null) {
	...
	public GroceryShopDTO() {
		// TODO Auto-generated constructor stub
	}

	public GroceryShopDTO(int itemId, String itemName, String itemBrand, int price, int quantity, String itemImage) {
		super();
		this.itemId = itemId;
		this.itemName = itemName;
		this.itemBrand = itemBrand;
