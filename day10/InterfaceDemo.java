...
public class InterfaceDemo {
	public static void main(String[] args) {
		 ...
		 * implementation, the bahavioral object becomes a component.
		 *
		 * Doctor is a spcial class whose activity is implemented in medical college,
		...
		DoBoth db = new DoBoth();
		shoiab = Proxy.newProxyInstance(Human.class.getClassLoader(), new Class[] { DoBoth.class },
				new MyInvocationHandler(db));// subjection - THIS IS HAPPENING AT RUNTIME
...
class DoBoth implements Pilot, Doctor {
	@Override
	public void doCure() {
		System.out.println("I do medical practice");

	}

	@Override
	public void doFly() {
		System.out.println("I do flying");
