...
<div class="container-fluid">	
	...
	<div class="container" style="padding-left: 8%;">
		<form action="../loadshop/shop3" method="post">

			<mytags:getdata number="2" />

			<div class="d-grid gap-2 col-6 mx-auto" style="padding: 5%;">
				<button class="btn btn-danger" type="submit">Shop Three</button>
			</div>
